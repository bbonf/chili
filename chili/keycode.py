...
def createStringForKey(keycode, shift=False):
...
codedict = {createStringForKey(code): (code,False) for code in range(128)}
codedict.update({createStringForKey(code, True): (code,True) for code in range(128)})

def keyCodeForChar(c):
    return codedict[c]

if __name__ == '__main__':
  # print codedict[u'h'], codedict['H']
  print codedict
